...
def _make_cfg(**over):
    base = {
        ...
        "approach_forward_step_m": 0.25,
        "grasp_approach_forward_reserve_m": 0.15,
        "approach_k_rot": 1.5,
        ...
        "grasp_servo_enabled": False,
        "grasp_servo_creep_k_fwd": 0.6,
        "grasp_servo_fwd_max_m": 1.2,
        "grasp_servo_commit_dist_m": 0.30,
